class Muninn < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "45f63aa972c729d52a125a174978a88d2e3e02e44b4be7043c0d64bb6d5e3bfe"  # darwin-arm64
    end

    on_intel do
      url "https://github.com/scrypster/muninndb/releases/download/v#{version}/muninn-darwin-amd64"
      sha256 "8f4fb3424f85801310976d9c0647b8b56907848eac210dc9abe2053f9200d371"  # darwin-amd64
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "a5ad5214949c834def33e6554324ccfa6f88b0de26b2783e84f141e164eca46c"  # linux-amd64
    end
  end
